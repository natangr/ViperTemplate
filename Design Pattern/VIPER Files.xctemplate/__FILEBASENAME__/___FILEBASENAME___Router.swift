...
class ___FILEBASENAME___Router {
    ...
    static func setupModule() -> ___FILEBASENAME___ViewController {
        let viewController = UIStoryboard(name: ___FILEBASENAME___ViewController.storyboardName).instantiateViewController(withIdentifier: ___FILEBASENAME___ViewController.reuseIdentifier) as! ___FILEBASENAME___ViewController
